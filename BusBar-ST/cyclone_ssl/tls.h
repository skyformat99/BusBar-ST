...
#elif (TLS_MAX_PROTOCOL_DATA_LENGTH < 1024)
...
#ifndef TLS_MAX_RECORD_LENGTH
   #define TLS_MAX_RECORD_LENGTH 16384
#elif (TLS_MAX_RECORD_LENGTH < 1024)
   #error TLS_MAX_RECORD_LENGTH parameter is not valid
#endif
