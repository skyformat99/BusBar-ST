...
//Temporary buffer
static uint8_t txTempBuffer[STM32F7XX_ETH_TX_BUFFER_SIZE];
...
//STM32756G-EVAL or STM32F746G-DISCOVERY evaluation board?
#if defined(USE_STM32756G_EVAL) || defined(USE_STM32746G_DISCO)
...
//STM32756G-EVAL evaluation board?
   ...
   const NetBuffer *buffer, size_t offset)
{
   ...
   netBufferRead(txTempBuffer, buffer, offset, length);
   memcpy((uint8_t *) txCurDmaDesc->tdes2, txTempBuffer, length);
